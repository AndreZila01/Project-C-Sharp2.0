...
<<<<<<< HEAD
	<div style="background-color: red; width: 100%;">
		...
		<div class="col-xs-8 col-sm-9 col-md-9 col-lg-9" style="background-color: green;">
			<div class="col-xs-1 col-sm-2 col-md-2 col-lg-2" style="padding-bottom: 2500px"></div>
			<div class="col-xs-10 col-sm-8 col-md-8 col-lg-8" style="margin-top: 15px; padding-bottom: 2500px; padding-left: 0px; padding-right: 0px; background-color: aliceblue; font-size: 30px;">
				<div style="background-color: aqua;">
					<div style="padding: 40px 25px 40px 25px; background-color: #BCC6CC; margin-bottom:10px; display: inline-block;">Div one</div>
					<div style="padding: 40px 25px 40px 25px; background-color: #E5E4E2; margin-bottom:10px; display: inline-block;">Div two</div>
					<div style="padding: 40px 25px 40px 25px; background-color: #E5E5E2; margin-bottom:10px;display: inline-block;">Div two</div>
					<div style="padding: 40px 25px 40px 25px; background-color: #E5E7E2; margin-bottom:10px; display: inline-block;">Div two</div>
					<div style="padding: 40px 25px 40px 25px; background-color: #e5e4e3; margin-bottom:10px; display: inline-block;">Div two</div>
				</div>
			</div>
			<div class="col-xs-1 col-sm-2 col-md-2 col-lg-2" style="padding-bottom: 2500px"></div>
			<br />
...
>>>>>>> c6af08635754e30dc1ea70573fa3aaedad1d81fc
</asp:Content>
